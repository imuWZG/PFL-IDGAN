...
def main():
    ...
    parser.add_argument("--model_save_path", type=str, default='/workspace/algorithm/code/models/CIFAR100-Encoder', help="Generator model save path")
    parser.add_argument("--dataset_root", type=str, default='/workspace/dataset/private/wzg_dataset/CIFAR100', help="Path to dataset")
    ...
    train_dataset = datasets.CIFAR100(root=opt.dataset_root, train=True, download=True, transform=transform)
    train_loader = DataLoader(train_dataset, batch_size=opt.batch_size, shuffle=True)

    # 加载验证集
    val_dataset = datasets.CIFAR100(root=opt.dataset_root, train=False, download=True, transform=transform)
