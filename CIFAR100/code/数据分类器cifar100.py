...
def Data_classifier(Encoder,data,real_c):
    ...
    while n_clusters_!=real_c:
        ...
        if n_clusters_==real_c or bb>10:
            break
...
def main():
    ...
    parser.add_argument("--model_save_path", type=str, default='/workspace/algorithm/code/models/CIFAR100-Encoder.pth', help="Generator model save path")
