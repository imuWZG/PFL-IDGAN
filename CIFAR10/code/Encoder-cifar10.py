...
def main():
    ...
    parser.add_argument("--model_save_path", type=str, default='/workspace/algorithm/code/models/CIFAR10-Encoder', help="Generator model save path")
    ...
    # 加载验证集
    val_dataset = datasets.CIFAR10(root=opt.dataset_root, train=False, download=True, transform=transform)
