...
def main():
    ...
    parser.add_argument("--gen_pro_epochs", type=int, default=8, help="Number of generator process epochs")
    ...
    parser.add_argument("--encoder_path", type=str, default="/workspace/algorithm/code/models/FashionMNISIT-Encoder.pth", help="Encoder path")
    ...
    parser.add_argument("--e", type=int, default=13.198, help="number of image channels")
    ...
    for i in range(args.clients_num):
        ...
        utils2.model_loading(PerFEDGAN_local_generator,
                            '/workspace/algorithm/code/models/FashionMNIST/loading_model/participant'+str(i)+'Generator50.pth',
                            '/workspace/algorithm/code/models/FashionMNIST/loading_model/participant'+str(i)+'Generator50.pth')
        utils2.model_loading(PerFEDGAN_local_discriminator,
                            '/workspace/algorithm/code/models/FashionMNIST/loading_model/participant'+str(i)+'Discriminator50.pth',
                            '/workspace/algorithm/code/models/FashionMNIST/loading_model/participant'+str(i)+'Discriminator50.pth')
        '''
    ...
    for i in range(args.clients_num):
        PFLDGAN_clients_model=utils2.create_custom_cnn_2(args.dataset_name,'PFLDGAN')
